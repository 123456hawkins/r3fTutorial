...
export const Podium = (props) => {
  ...
  return (
    <group {...props}>
      ...
      <animated.mesh castShadow scale-y={bearPodiumScale} rotation-y={bearPodiumRotation}>
        <boxGeometry />
      ...
      <group position={[3, 0, 0]}>
        ...
        <animated.mesh castShadow scale-y={dogPodiumScale} rotation-y={dogPodiumRotation}>
          <boxGeometry />
