...
export default function Burger(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF("/models/springAnimationModel/burger/model.gltf");
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      >
        <meshStandardMaterial  {...hawkinsMaterials.green} />
      </animated.mesh>
...
useGLTF.preload("/models/springAnimationModel/burger/model.gltf");
